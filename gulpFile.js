(function(){
    ...
    var client = {
      ...
      stylus: ['./client/app/core/styles/index.styl', './client/app/modules/**/*.index.styl'],
      coreStyles:'./client/app/core/styles',
      ...
      bootstrap: './client/app/styles/bootstrap/bootstrap.styl',
      bootstrapDest: './client/css',
      vendor: [
        './client/vendor/angular/ngstorage/ngStorage.js',
        './client/vendor/angular/oclazyload/ocLazyLoad.js',
        './client/vendor/angular/angular-translate/angular-translate.js',
        './client/vendor/angular/angular-translate/loader-static-files.js',
        './client/vendor/angular/angular-translate/storage-cookie.js',
        './client/vendor/angular/angular-translate/storage-local.js'
      ],
      controllers:['./client/js/**/*.js']
    ...
    gulp
      .task('build:dev', $.sequence('templates:dev', ['stylus:dev', 'bootstrap'], 'scripts:dev', 'inject:dev', 'bower:dev'))
      .task('templates:dev', tasks.dev.templates)
      .task('bootstrap', tasks.dev.bootstrap)
